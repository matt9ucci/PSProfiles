# The original file was retrieved from https://dot.net/v1/dotnet-install.ps1 at 2021/01/10
#
...
#    [string]$InstallDir="<auto>",
   [string]$InstallDir = (Join-Path $USERAPPS Dotnet $Channel),
    ...
    Invoke-With-Retry(
    {
        ...
        try {
            ...
            if (Test-Path $PROFILEDIR\PwshProxy.xml) {
                ...
                $HttpClientHandler = New-Object System.Net.Http.HttpClientHandler
                $HttpClientHandler.Proxy = New-Object System.Net.WebProxy $proxy
